defmodule LeonApiWeb.Auth.Guardian do
  use Guardian, otp_app: :leon_api
  alias LeonApi.Accounts

  #the code generates a subject for a JWT token
...
#the code retrieves a resource based on a JWT token
