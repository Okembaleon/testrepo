defmodule LeonApiWeb.AccountController do
  use LeonApiWeb, :controller

  alias LeonApiWeb.{Auth.Guardian, Auth.ErrorResponse}
  alias LeonApi.{Accounts, Accounts.Account, Users, Users.User}

  import LeonApiWeb.Auth.AuthorizedPlug

  plug :is_authorized when action in [:update, :delete]

  action_fallback LeonApiWeb.FallbackController
